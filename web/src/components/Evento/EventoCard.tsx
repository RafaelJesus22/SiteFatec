...
const img = 'https://www.fatecsdp.edu.br/carrega/noticias/2019/12/750_390_crop_1575403969.jpg';
...
export const EventoCard = (props: EventoCardProps): JSX.Element => {
	...
	return (
		<div className='event'>
			...
			<img src={image || img} alt="Imagem da noticia" className="event__image" />
